import type { ContactDetailProps, MemberDetailProps,ValProps } from "@/utils/aboutUs/types";
...
export const ContactCard = ({ contactDetail }: { contactDetail: ContactDetailProps }) => (
    <div className="flex gap-[20px]">
        <div className="size-[64px] rounded-full border-1 border-primary p-[12px]">
            <Image className="size-[40px] m-auto" src={contactDetail.icon} alt="" />
        </div>
...
export const MemberCard = ({ member }: { member: MemberDetailProps }) => (
    <div className="flex flex-col gap-[20px] items-center justify-center">
        <div className="relative z-0">
            <Image src={member.icon} className="w-[100px] h-[162px] object-cover z-30" alt="" />
            <Parellelo />
        </div>
