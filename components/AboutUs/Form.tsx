const Form = () => {
    const inputStyle =
        "p-[15.8px_24.8px_17.4px_24.8px] rounded-[8px] border-1 border-primary justify-center container bg-[#191919] text-[14px] text-white focus:outline-none focus:border-2 ";
    const labelStyle = "flex text-[16px] font-[500]";
    const Star = () => <div className="text-[16px] text-primary">*</div>;

    return (
        <div className="flex flex-col py-[40px] container px-[44px] bg-[#45413DCC] rounded-[4px_24px] gap-[20px]">
            <p className="uppercase font-elemental-end text-[20px] text-white">contact us</p>

            <div className="flex flex-col md:flex-row justify-between container gap-[20px] md:gap-[100px]">
