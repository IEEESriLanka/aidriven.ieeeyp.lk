...
const Page = () => {
    return (
        <div className="font-poppins pt-[201px] mx-[auto] md:w-[1064px] text-white items-center  justify-center flex flex-col gap-[102px] px-[40px] md:px-0">
            {/* about */}
            ...
            <div className="flex flex-col w-full gap-[40px] ">
                ...
                <div className="flex flex-col md:flex-row rounded-[4px_44px] bg-[linear-gradient(180deg,rgba(69,65,61,0.40)_0%,rgba(58,53,49,0.40)_48.56%,rgba(52,47,42,0.40)_100%)] justify-center items-center md:gap-[65px] ">
                    ...
                    <div className="text-[14px] py-[35px] md:w-[746px] w-full px-[40px]">
